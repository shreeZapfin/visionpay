...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::patch('user/withdrawal/bank-request/{withdrawal}', [\App\Http\Controllers\WithdrawalController::class, 'processBankRequest']);
    ...
    Route::middleware(['can:view,user', 'can:viewAny,App\Models\User', 'can:update,user'])->group(function () {
    ...
    Route::post('fund-request/create', [\App\Http\Controllers\FundRequestController::class, 'create']);
    Route::patch('fund-request/{fundrequest}/accept', [\App\Http\Controllers\FundRequestController::class, 'accept']);
    Route::patch('fund-request/{fundrequest}/reject', [\App\Http\Controllers\FundRequestController::class, 'reject']);




    Route::post('send-funds', [\App\Http\Controllers\FundRequestController::class, 'sendFundsDirectly'])->middleware(['voucher.validity']);
    ...
    Route::patch('admin/user/{user}/account-block', [\App\Http\Controllers\UserController::class, 'accountBlockStatus']);
    Route::patch('admin/user/{user}/wallet-balance-block', [\App\Http\Controllers\UserController::class, 'blockWalletBalance']);
    ...
    Route::post('/alert', [\App\Http\Controllers\AlertsController::class, 'sendAlert']);
    ...
    Route::post('/bill-payment/{biller}/pay', [\App\Http\Controllers\BillPaymentsController::class, 'payBill'])->middleware(['voucher.validity']);
    ...
    Route::apiResource('/promotion', \App\Http\Controllers\PromotionController::class)->only('index', 'store', 'update');
    ...
    Route::apiResource('complaint', \App\Http\Controllers\ComplaintController::class);
