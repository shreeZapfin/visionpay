...
<!-- <li class="nav-item active">
    ...
    @if (in_array(\Illuminate\Support\Facades\Auth::user()->user_type_id,[\App\Enums\UserType::Admin,\App\Enums\UserType::Staff]))
        ...
        <li class="nav-item active" id="user"><a class="nav-link collapsed" href="{{ asset('user') }}"
            ...
            <div id="collapseUsers" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can(\App\Enums\Permissions::VIEW_USER)<a class="collapse-item" href="{{ asset('users') }}">All
                        Users</a>@endcan
                    @can(\App\Enums\Permissions::CREATE_USER)<a class="collapse-item" href="{{ asset('addUser') }}">Add
                        New User</a>@endcan
                    @can(\App\Enums\Permissions::VIEW_USER)
                        ...
                        <a class="collapse-item" href="{{ asset('incompleteRegisterUser') }}">Incomplete
                            Registration</a>
                    @endcan
                </div>
            </div>
        ...
        <li class="nav-item active" id="merchant"><a class="nav-link collapsed" href="{{ asset('merchant') }}"
                                                     data-toggle="collapse" data-target="#collapseMerchant"
                                                     aria-expanded="true"
                                                     aria-controls="collapseMerchant"> <i
                        class="fas fa-fw fa-users"></i> <span>Merchants</span></a>
            <div id="collapseMerchant" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">

                    @can(\App\Enums\Permissions::VIEW_USER)<a class="collapse-item" href="{{ asset('merchants') }}">All
                        Merchant</a>@endcan
                    @can(\App\Enums\Permissions::CREATE_USER) <a class="collapse-item"
                                                                 href="{{ asset('addMerchant') }}">Add
                        New Merchant</a>@endcan
                    @can(\App\Enums\Permissions::VIEW_USER)
        ...
        <li class="nav-item active" id="admin"><a class="nav-link collapsed" href="{{ asset('agents') }}"
                                                  ...
                                                  aria-expanded="true"
                                                  aria-controls="collapseAgents"> <i class="fas fa-fw fa-users"></i>
                <span>Agents</span></a>
            ...
            <div id="collapseAgents" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can(\App\Enums\Permissions::VIEW_USER)  <a class="collapse-item" href="{{ asset('agents') }}">All
                        Agents</a>@endcan
                    @can(\App\Enums\Permissions::CREATE_USER)    <a class="collapse-item"
                                                                    href="{{ asset('addAgent') }}">Add New
                        agent</a>@endcan
                    @can(\App\Enums\Permissions::VIEW_USER)
        ...
        <li class="nav-item active" id="bill_payment"><a class="nav-link collapsed" href="{{ asset('bill_payment') }}"
                                                         data-toggle="collapse" data-target="#collapseBillPayment"
                                                         aria-expanded="true"
            ...
            <div id="collapseBillPayment" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    @can(\App\Enums\Permissions::VIEW_USER) <a class="collapse-item" href="{{ asset('biller-list') }}">Billers</a>@endcan
                    {{-- <a class="collapse-item" href="{{ asset('billers') }}">Edit Biller</a> --}}
                    @can(\App\Enums\Permissions::VIEW_USER) <a class="collapse-item"
                                                               href="{{ asset('biller-category') }}">Services</a>@endcan
                    <a class="collapse-item" href="{{ asset('bill-payment-report') }}">Biller Report</a>
                    @can(\App\Enums\Permissions::MANAGE_USER_WALLET)<a class="collapse-item"
                                                                       href="{{ asset('biller-withdrawal-funds') }}">Withdraw
                        Funds</a>@endcan
                </div>
            </div>
        </li>
        ...
        <li class="nav-item active" id="reports"><a class="nav-link collapsed" href="{{ asset('reports') }}"
            ...
            <div id="collapseReports" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    @can(\App\Enums\Permissions::MANAGE_USER_WALLET)   <a class="collapse-item"
                                                                          href="{{ asset('fund-request-list') }}">Fund
                        Request</a> @endcan
                    <a class="collapse-item" href="{{ asset('wallet-history-list') }}">Admin Wallet History</a>
                    <a class="collapse-item" href="{{ asset('admin-master-history') }}">Master Wallet History</a>
        ...
        @if (in_array(\Illuminate\Support\Facades\Auth::user()->user_type_id,[\App\Enums\UserType::Admin]))
            <li class="nav-item active" id="rewards"><a class="nav-link collapsed" href="{{ asset('rewards') }}"
                                                        data-toggle="collapse" data-target="#collapseRewards"
                                                        aria-expanded="true"
                                                        aria-controls="collapseSetting">
        ...
        @endif
        @can(\App\Enums\Permissions::MANAGE_COMPLAINT)
            <li class="nav-item active" id="complaint"><a class="nav-link collapsed" href="{{ asset('complaint') }}"
                                                          data-toggle="collapse" data-target="#collapseComplaint"
                                                          aria-expanded="true"
                                                          aria-controls="collapseSetting">
                ...
                <div id="collapseComplaint" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        @if (in_array(\Illuminate\Support\Facades\Auth::user()->user_type_id,[\App\Enums\UserType::Admin]))
                            <a class="collapse-item" href="{{ asset('complaint_type') }}">Ticket Type</a> @endif
        ...
        @if (in_array(\Illuminate\Support\Facades\Auth::user()->user_type_id,[\App\Enums\UserType::Admin]))
            <li class="nav-item active" id="appgrid"><a class="nav-link collapsed" href="{{ asset('appgrid') }}"
                                                        data-toggle="collapse" data-target="#collapseAppgrid"
                                                        aria-expanded="true"
          ...
          <a class="collapse-item" href="{{ asset('viewAdminUser') }}">Admin Users</a>
          <a class="collapse-item" href="{{ asset('viewUserActivity') }}">User Activity</a>
        ...
        @can(\App\Enums\Permissions::MANAGE_ADVERTISEMENT)
            <li class="nav-item active" id="advertisement"><a class="nav-link collapsed"
                                                              href="{{ asset('advertisement') }}"
                                                              data-toggle="collapse"
                                                              data-target="#collapseAdvertisement"
                                                              aria-expanded="true"
                                                              aria-controls="collapseAdvertisement">
                    <i class="fas fa-solid fa-piggy-bank"></i><span>Advertisement</span></a>
                <div id="collapseAdvertisement" class="collapse" aria-labelledby="headingUtilities"
                     data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
        ...
        @can(\App\Enums\Permissions::MANAGE_USER_WALLET)
            <li class="nav-item active" id="bank_withdrawal"><a class="nav-link collapsed"
                                                                href="{{ asset('bank_withdrawal') }}"
                                                                data-toggle="collapse"
