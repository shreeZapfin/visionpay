        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h5>Get Started with PacPay,</h5>
                    <h6>Her's your report overview for today.</h6>
                    </h5>
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <form name='addFunds' id='addFunds'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="Enter Transaction Pin"
                                                            class="form-control" name="transaction_pin"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" placeholder="Enter Voucher Code"
                                                            class="form-control" name="voucher_code" id="voucher_code"
                                                            required />
                                                    </div>
                                                </div>
                                            </div>
