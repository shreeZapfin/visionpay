                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="user_type_id" id="user_type_id"
                                                                    ...
                                                                    <option value="-1" selected="selected">Select User Type</option>
                                                                    <option value="3">Agent</option>
                                                                    <option value="2">Customer/User</option>
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-xl-6 col-lg-6 col-sm-6">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-sm-6 agents_merchant">
                                                        <div class="form-group">
...
@section('scripts')
    ...
    <script type="text/javascript">
            $(".agents_merchant").hide();

        $(document.body).on("change","#user_type_id",function(){
            if(this.value == 3 || this.value == 4 ){
                $(".agents_merchant").show();
            }else{
                $(".agents_merchant").hide();
            }
        });
                    ...
                    if (data.status === 422) {
                        ...
                        $.each(errors, function(key, value) {
                            ...
                            if ($.isPlainObject(value)) {
                                ...
                                //SCROLL DOWN PAGE WHEN ERROR OCCURED
