                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h5 class="m-0 font-weight-bold text-primary">Admin Users</h5>
                            ...
                            <div class="input-group input-daterange">
                                ...
                                <div class="input-group col-sm">
                                    ...
                                    <a type="button" name="export" id="export" class="btn btn-block"
                                        href="{{ url('api/user/search?user_type_id=9&download_csv=1') }}"
                                ...
                                <div class="input-group col-sm">
                                    ...
                                    <a type="button" name="export" id="export" class="btn btn-block"
                                        href="{{ asset('addAdminUser') }}"
                                        style="text-align: center; margin-top:30px; height : 40px; width: 150px; background:	#0066CD; color: rgb(255,255,255);">Add New User</a>
                                </div>
