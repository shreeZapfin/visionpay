...
@section('content')
                    ...
                    <div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
                        <h1 class="page-title">UnVerified Agents</h1>
                        <div>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/index')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">UnVerified Agents</li>
                            </ol>
                        </div> 
                    </div>
                    <!-- PAGE-HEADER END -->
        ...
        $(document).ready(function() {
            ...
            $('#dataTable').DataTable({
                ...
                "columns": [{
                    ...
                    {
                        data: 'user_events[<br><br>].event'
                    },
                    {
                        data: 'user_events[<br><br>]..remark'
                    },
                    {
                        data: 'user_events[<br><br>]..action_user_full_name'
                    }
                ]
